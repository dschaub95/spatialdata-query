...
def run_sdata_polygon_query_shapes(sdata, polygon, element_key):
    return sd.polygon_query(sdata[element_key], polygon, "global")
...
if __name__ == "__main__":
    ...
    result = run_sdata_polygon_query_shapes(sdata, polygon, element_key)
