...
def run_sdata_bbox_query_points(sdata, min_coordinate, max_coordinate, element_key):
    queried = sd.bounding_box_query(
        sdata[element_key],
        axes=("x", "y"),
...
if __name__ == "__main__":
    ...
    result = run_sdata_bbox_query_points(sdata, min_coordinate, max_coordinate, element_key)
